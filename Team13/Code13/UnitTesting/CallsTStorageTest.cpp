...
namespace UnitTesting {
    TEST_CLASS(CallsTStorageTest) {
        CallsTStorage callsTStorage = CallsTStorage();
        SuchThatStorage* storage = &callsTStorage;

        TEST_METHOD_INITIALIZE(initializeCallsTStorageWithEntityPairs) {
        ...
        TEST_METHOD(testAddCallsTRelationships) {
            Assert::IsTrue(storage->getLhsMap()->size() == 5);
            Assert::IsTrue(storage->getRhsMap()->size() == 6);
            Assert::IsTrue(storage->getEntityPairSet()->size() == 13);
        };
        ...
        TEST_METHOD(testGetLhsConstantRhsSyn) {
            ...
            std::list<PKBEntity> result5 = storage->getLhsConstantRhsSyn({ "prod2", QueryConstantType::Identifier }, EntityType::Procedure);
            Assert::IsTrue(result5.size() == 3);
        ...
        TEST_METHOD(testGetLhsConstantRhsConstant) {
            ...
            bool result8 = storage->hasLhsConstantRhsConstant({ "prod1", QueryConstantType::Identifier }, { "prod4", QueryConstantType::Identifier });
            Assert::IsTrue(result8);

            bool result9 = storage->hasLhsConstantRhsConstant({ "prod1", QueryConstantType::Identifier }, { "prod5", QueryConstantType::Identifier });
            Assert::IsTrue(result9);

            bool result10 = storage->hasLhsConstantRhsConstant({ "prod2", QueryConstantType::Identifier }, { "prod5", QueryConstantType::Identifier });
            Assert::IsTrue(result10);

            bool result11 = storage->hasLhsConstantRhsConstant({ "prod2", QueryConstantType::Identifier }, { "prod7", QueryConstantType::Identifier });
            Assert::IsTrue(result11);

            bool result12 = storage->hasLhsConstantRhsConstant({ "prod1", QueryConstantType::Identifier }, { "prod6", QueryConstantType::Identifier });
            ...
            bool invalidResult3 = storage->hasLhsConstantRhsConstant({ "prod7", QueryConstantType::Identifier }, { "prod5", QueryConstantType::Identifier });
            Assert::IsTrue(!invalidResult3);

            bool invalidResult4 = storage->hasLhsConstantRhsConstant({ "prod7", QueryConstantType::Identifier }, { "prod1", QueryConstantType::Identifier });
